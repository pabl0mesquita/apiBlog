...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= asset('/css/projetos/brafe/bootstrap.min.css') ?>">
	<link rel="stylesheet" type="text/css" href="<?= asset('/css/projetos/brafe/style.css') ?>">
...
<body>
	...
	<header class="menu">
		<div class="container">
			<div class="row">
				<a class="menu-logo col-md-4" href="#"><img src="<?= asset('/img/brafe/brafe.png') ;?>" alt="Brafé"></a>	
	...
	<section class="sobre container">
		...
		<div class="row">
			<div class="col-sm sobre-item">
				<img src="<?= asset('/img/brafe/cafe-1.jpg') ;?>">
				<h3>amor</h3>
			</div>
			<div class="col-sm sobre-item">
				<img src="<?= asset('/img/brafe/cafe-2.jpg') ;?>">
				<h3>perfeição</h3>
			</div>
		</div>
...
aente quente, mas também pode ser consumido gelado. Ele é um estimulante, por possuir cafeína — geralmente 80 a 140 mg para cada 207 ml dependendo do método de preparação.</p>
	...
	<section class="locais container">
		<div class="locais-item row">
			<div class="col-sm">
				<img src="<?= asset('/img/brafe/botafogo.jpg') ;?>" alt="Brafé unidade Botafogo">
			</div>
			<div class="col-sm">
				<h2>Botafogo</h2>
		...
		<div class="locais-item row">
			<div class="col-sm">
				<img src="<?= asset('/img/brafe/iguatemi.jpg') ;?>" alt="Brafé unidade Iguatemi">
			</div>
			<div class="col-sm">
				<h2>Iguatemi</h2>
				<p>As condições climáticas não eram as melhores nessa primeira escolha e, entre 1800 e 1850, tentou-se o cultivo.</p>
		...
		<div class="locais-item row">
			<div class="col-sm">
				<img src="<?= asset('/img/brafe/botafogo.jpg') ;?>" alt="Brafé unidade Mineirão">
			</div>
			<div class="col-sm">
				<h2>Mineirão</h2>
				<p>As condições climáticas não eram as melhores nessa primeira escolha e, entre 1800 e 1850, tentou-se o cultivo.</p>
	...
	<footer class="footer">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm">
					<img src="<?= asset('/img/brafe/brafe.png') ;?>" alt="Brafé">
				</div>
			</div>
		</div>
	</footer>
